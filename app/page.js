...
function Button({ children, variant = "primary" }) {
  return (
    <button className={variant === "outline" ? "button button-outline" : "button"}>
      {children}
    </button>
  );
}
    ...
    <div className="site">
      <header className="header">
        <div className="header-inner">
          <div className="brand">
            ...
            <div>
              <p className="brand-title">CommunityFirst</p>
              <p className="brand-subtitle">Healthcare Consulting</p>
            </div>
          </div>
      ...
      <main>
          ...
          <div className="container hero-grid">
            ...
            >
              ...
              <div className="hero-buttons">
                <a href="#contact">
                  <Button>
                    Start with a Diagnostic <ArrowRight size={18} />
                  </Button>
                </a>
                <a href="#pilot">
              ...
              <Card className="feature-card">
                <div className="feature-heading">
                  ...
                  <div>
                    ...
                    <h2>Rural Practice Diagnostic</h2>
                  </div>
                </div>
        ...
        <section className="container problem-section">
          ...
          <div className="pain-list">
            {painPoints.map((point) => (
              <div key={point} className="pain-item">
                <CheckCircle size={20} />
                <p>{point}</p>
              </div>
            ))}
        ...
        <section id="process" className="process">
          <div className="container">
            <div className="section-intro">
              <p className="section-kicker green">How it works</p>
              <h2>A simple process built around action.</h2>
            </div>
            ...
            <div className="contact-card">
              <div className="contact-heading">
                ...
                <div>
                  ...
                  <p>A practical conversation. No pressure.</p>
                </div>
              </div>
              ...
              <div className="form">
                ...
                <p>
                  This form is visual only for now. Later, connect it to Formspree, Tally, HubSpot,
                  or Calendly.
                </p>
              </div>
            </div>
