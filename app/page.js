      ...
      <header className="header">
        <div className="header-inner">
          <a href="#" className="brand-logo" aria-label="CommunityFirst Healthcare Consulting home">
            <img src="/communityfirst-logo.png" alt="CommunityFirst Healthcare Consulting logo" />
          </a>
          ...
          <div className="container contact-grid">
            ...
            <div className="contact-card">
              ...
              <div className="form">
                ...
                <p>This form is visual only for now. Later, connect it to Formspree, Tally, HubSpot, or Calendly.</p>
              </div>
            </div>
          </div>
        </section>
